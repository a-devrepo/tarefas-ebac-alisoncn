  ...
  public void createDataBases() {
    do {
      ...
      try {
        ...
        addEntityManagerFactory(Constants.Databases.PERSISTENCE_UNIT_NAME_DB2);
        addEntityManagerFactory(Constants.Databases.PERSISTENCE_UNIT_NAME_DB3);

        if (isOpen(Constants.Databases.PERSISTENCE_UNIT_NAME_DB1)
            && isOpen(Constants.Databases.PERSISTENCE_UNIT_NAME_DB2)
            && isOpen(Constants.Databases.PERSISTENCE_UNIT_NAME_DB3)) {
          break;
        }
