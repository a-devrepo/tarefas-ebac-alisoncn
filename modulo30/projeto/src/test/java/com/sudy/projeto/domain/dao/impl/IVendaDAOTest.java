...
public class IVendaDAOTest {
  ...
  public IVendaDAOTest() {
    vendaDAO = new ImplVendaDAO();
  ...
  public void salvarVendaTest() throws DAOException {
    ...
    Boolean cadastrado = vendaDAO.salvar(venda);
  ...
  public void consultarVendaTest() throws DAOException, RegistroNaoEncontradoException {
    ...
    Venda vendaCadastrada = vendaDAO.buscar(venda.getCodigo());
  ...
  public void cancelarVendaTest() throws DAOException, RegistroNaoEncontradoException {
    ...
    vendaCadastrada = vendaDAO.buscar(venda.getCodigo());
  ...
  public void finalizarVendaTest() throws DAOException, RegistroNaoEncontradoException {
    ...
    vendaDAO.concluirVenda(vendaCadastrada);
  ...
  public void aumentarQuantidadedeProdutoDaVenda()
    ...
    vendaDAO.alterarQuantidadeProdutosVenda(vendaCadastrada, produto.getCodigo());
  ...
  public void cadastrarProdutoDiferenteAVendaTeste()
    ...
    Venda vendaCadastrada = vendaDAO.buscar(codigoVenda);

    vendaCadastrada.adicionarProduto(produtoDiferente, quantidadeProdutoNovo);

    vendaDAO.adicionarNovoProdutoAVenda(vendaCadastrada, produtoDiferente, quantidadeProdutoNovo);

    vendaCadastrada = vendaDAO.buscar(codigoVenda);
  ...
  public void removerProdutoVendaTeste()
    ...
    vendaDAO.adicionarNovoProdutoAVenda(vendaCadastrada, produtoNovo, quantidadeProdutoNovo);

    vendaCadastrada = vendaDAO.buscar(codigoVenda);

    vendaCadastrada.removerProduto(this.produto, quantidadeARemover);

    vendaDAO.removerProdutoDeVenda(vendaCadastrada, this.produto, quantidadeARemover);
  ...
  public void removerUmaUnidadeDeProdutoVendaTeste()
    ...
    vendaDAO.removerProdutoDeVenda(vendaCadastrada, produtoNovo, quantidadeARemover);
  ...
  public void removerTodosProdutosDeVendaTeste()
    ...
    vendaDAO.removerTodosProdutosDeVenda(vendaCadastrada);
  ...
  public void adicionarProdutoVendaAposConcluidaTest()
    ...
    Venda vendaConcluida = vendaDAO.buscar(venda.getCodigo());
